...
Rectangle::Rectangle(const Model & object, glm::mat4 matrix)
{
...
bool Rectangle::overlaps(const Rectangle & otherRect){
	glm::vec2 verts1[2];
	glm::vec2 verts2[2];
...
//TODO
bool Rectangle::contains(const Rectangle & otherRect){
	return true;
}